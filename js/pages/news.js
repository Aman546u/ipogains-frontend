...
async function loadNews() {
    try {
            ...
            <div class="news-card">
                ...
                <div class="news-content">
                    ...
                    <div class="news-meta">
                        ...
                        <a href="news-detail.html?slug=${item.slug}" class="read-more-btn">Read More <i class="fas fa-arrow-right"></i></a>
                    </div>
                </div>
            </div>
        `).join('');
        ...
        document.getElementById('loading').innerHTML = '<p class="text-danger">Failed to load news</p>';
    }
}
